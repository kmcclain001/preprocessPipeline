...
createChannelMapFile_KSW(basepath,'staggered'); % poly3
...
if isdir('F:\Kilosort')
    ...
    ops.fproc = ['F:\Kilosort\temp_wh.dat'];
else
...
[rez, DATA, uproj] = preprocessData_medianSubstraction(ops); % preprocess data and extract spikes for initialization
